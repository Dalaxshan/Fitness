                        ...
                        >
                            ...
                            >
                                <Stack spacing={1}>
                                    ...
                                    />
                                    <TextField
                                        error={!!(formik.touched.member?.contactNumber && formik.errors.member?.contactNumber)}
                                        fullWidth
                                        helperText={formik.touched.member?.contactNumber && formik.errors.member?.contactNumber}
                        ...
                        >
                            ...
                            >
                                <Stack spacing={1}>
                                    ...
                                    />
                                    <NumericFormat error={!!(formik.touched.totalAmount && formik.errors.totalAmount)}
                                        fullWidth
                                        label="Total Price"
                                        name="totalAmount"
                                        onBlur={formik.handleBlur}
